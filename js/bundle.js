...
/***/ "./src/scss/portfolio_categories.scss":
/*!********************************************!*\
  !*** ./src/scss/portfolio_categories.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://tanya_zaricka/./src/scss/portfolio_categories.scss?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ portfolio)\n/* harmony export */ });\nfunction portfolio() {\n\n\n    if (document.querySelectorAll('.portfolio_categorie__item')) {\n\n\n        const categorie = document.querySelector('section'),\n              photos = document.querySelectorAll('.portfolio_categorie__item');\n              let time = 1.4;\n\n            \n\n\n        switch (categorie.getAttribute('data-categorie')) {\n            case 'portraits': \n                for (let i = 0; i <= photos.length; i++) {\n                photos[i].classList.add(i);\n                photos[i].style.background = `url('./assets/Portfolio__photos/Portraits/${i}.webp') 50% 30%/cover no-repeat`\n                photos[i].style.animation = `fade 1.6s ease-out ${time}s forwards`\n                time += 0.3\n            };\n                break;\n\n            case 'love-story':\n                for (let i = 0; i <= photos.length; i++) {\n                    photos[i].classList.add(i);\n                    photos[i].style.background = `url('./assets/Portfolio__photos/Love_story/${i}.webp') 50% 40%/cover no-repeat`\n                    photos[i].style.animation = `fade 1.6s ease-out ${time}s forwards`\n                    time += 0.3\n                };\n                break;\n\n            case 'family':\n                for (let i = 0; i <= photos.length; i++) {\n                    if (window.innerWidth <= 430) {\n                        switch (i+1) {\n                            case 1: photos[i].style.cssText = 'grid-row: span 2'\n                                break\n                            case 7: photos[i].style.cssText = 'grid-row: span 2'\n                                break\n                            case 11: photos[i].style.cssText = 'grid-row: span 2'\n                                break\n                        }\n                    }\n\n                    if (window.innerWidth > 430 && innerWidth < 730) {\n                        switch (i+1) {\n                            case 1: photos[i].style.cssText = 'grid-row: span 1'\n                                break\n                            case 7: photos[i].style.cssText = 'grid-row: span 1'\n                                break\n                            case 11: photos[i].style.cssText = 'grid-row: span 1'\n                                break\n                        }\n                    }\n\n                    if (window.innerWidth > 1090) {\n                        switch (i+1) {\n                            case 1: photos[i].style.cssText = 'grid-column: span 4'\n                                break\n                            case 7: photos[i].style.cssText = 'grid-column: span 4'\n                                break\n                            case 11: photos[i].style.cssText = 'grid-column: span 4'\n                                break\n                        }\n                    }\n\n                    if (window.innerWidth >= 730 && window.innerWidth <= 1090) {\n                        switch (i+1) {\n                            case 1: photos[i].style.cssText = 'grid-column: span 4'\n                                break\n                            case 7: photos[i].style.cssText = 'grid-column: span 4'\n                                break\n                            case 4: photos[i].style.cssText = 'grid-column: span 4'\n                            case 11: photos[i].style.cssText = 'order: 12; grid-column: span 4'\n                            \n                        }\n                    }\n                    photos[i].style.background = `url('./assets/Portfolio__photos/Family/family_${i + 1}.webp') 50% 50%/cover no-repeat`\n                    photos[i].style.animation = `fade 1.6s ease-out ${time}s forwards`\n                    time += 0.3\n                };\n                break;\n\n            case 'fashion':\n                for (let i = 0; i <= photos.length; i++) {\n                    photos[i].classList.add(i);\n                    photos[i].style.background = `url('./assets/Portfolio__photos/Fashion/${i}.webp') 50% 40%/cover no-repeat`\n                    photos[i].style.animation = `fade 1.6s ease-out ${time}s forwards`\n                    time += 0.3\n                };\n                break;\n\n        }\n\n      \n    }\n\n}\n\n//# sourceURL=webpack://tanya_zaricka/./src/js/modules/portfolio.js?");
